...
/*
 ...
 to edit style, change the definitions or override contentView:
*/

#define BACKGROUND_COLOR       [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.5]

#define MESSAGE_TEXTCOLOR       [UIColor whiteColor]
#define MESSAGE_TEXTFONT        [UIFont boldSystemFontOfSize:16.]
#define MESSAGE_TEXTALIGNMENT   NSTextAlignmentCenter
